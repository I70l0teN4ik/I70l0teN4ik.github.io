...
const API_KEY = 'AIzaSyADdPXvd1a7Jjc0LG0oE-tjwRhSkWPknH4';
...
function onSignIn() {
    ...
    toggleHidden('profile_img');
    toggleHidden('signin_btn');
    showInfo('Signed in.');
...
function initClient() {
    gapi.client.init({
        ...
        gapi.auth2.getAuthInstance().user
